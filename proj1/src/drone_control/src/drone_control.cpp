...
DroneControl::DroneControl() : Node("drone_control_node")
{
    ...
    state_sub_ = this->create_subscription<mavros_msgs::msg::State>(
        "mavros/state", 10, std::bind(&DroneControl::state_cb, this, std::placeholders::_1));
    ...
    local_pos_sub_ = this->create_subscription<geometry_msgs::msg::PoseStamped>(
            "/mavros/local_position/pose", qos, std::bind(&DroneControl::local_pos_cb, this, std::placeholders::_1));
...
void DroneControl::local_pos_cb(const geometry_msgs::msg::PoseStamped::SharedPtr msg)
{
